  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <motion.p
            className="eyebrow mb-3.5 inline-flex max-w-full items-center gap-2.5 text-[0.68rem] tracking-[0.14em] text-[#f0c48a] drop-shadow-[0_1px_10px_rgba(0,0,0,0.7)] sm:mb-3 sm:gap-3 sm:text-[0.74rem] sm:tracking-[0.12em] sm:text-[#e8b478] md:ml-auto md:flex-row-reverse"
