...
export const internationalHub = {
    ...
    sections: [
      {
        ...
        body: [
          "Ingegneri e architetti stranieri, general contractor, fabricator europei e investitori che devono realizzare o coordinare opere in Italia e cercano uno studio strutturale di riferimento sul territorio.",
  ...
  en: {
    ...
    lead:
      "English-speaking structural engineering in Northern Italy — steel structures, shop drawings and site support for overseas architects, engineers, contractors and EU fabricators building in Italy.",
    sections: [
      {
        id: "who",
        heading: "Who we work with",
        body: [
          "Foreign engineers and architects, general contractors, EU fabricators and investors who need a local structural partner for projects in Italy.",
