...
export const galleryAltEnBySrc: Record<string, string> = {
  "/assets/residenziale/architettura-bergamo.webp": "Architectural volumes of the private steel residence in Pollenza (MC)",
  "/assets/residenziale/ingegneria-civile-brescia.webp": "Steel structure erection for the residential villa in Pollenza (MC)",
  "/assets/residenziale/ingegneria-urbanistica.webp": "Integrated steel villa design with landscape insertion in Pollenza (MC)",
  "/assets/residenziale/progettazione-strutture-acciaio.webp": "Interiors with steel frame and large spans in the private Pollenza (MC) residence",
  "/assets/residenziale/progettazione-strutture-acciaio-franciacorta.webp": "Construction detail of the steel load-bearing structure — Pollenza (MC) residence",
  "/assets/residenziale/strutture-acciaio-bergamo.webp": "Steelwork during construction of the steel villa in Pollenza (MC)",
  "/assets/residenziale/studio-ingegneria-architettura-adro.webp": "Construction site of the private steel residence in Pollenza (MC)",
  "/assets/residenziale/villa-acciaio-lusso.webp": "Overview of the steel structure integrated into the Pollenza (MC) landscape",
  ...
  "/assets/residenziale/villa-acciaio-salsomaggiore/fondazioni-su-pali-villa-acciaio.webp": "Concrete pour for pile foundations — steel villa in Salsomaggiore Terme (PR)",
  "/assets/residenziale/villa-acciaio-salsomaggiore/murature-cemento-armato-seminterrato.webp": "Reinforced-concrete basement walls and stair core — Salsomaggiore Terme (PR)",
  "/assets/residenziale/villa-acciaio-salsomaggiore/cantiere-villa-acciaio-salsomaggiore.webp": "Site view with reinforced-concrete foundations — steel villa in Salsomaggiore Terme (PR)",
  "/assets/residenziale/villa-acciaio-salsomaggiore/carpenteria-metallica-villa-acciaio.webp": "Erection of the load-bearing steel frame — steel villa in Salsomaggiore Terme (PR)",
  "/assets/residenziale/villa-acciaio-salsomaggiore/struttura-acciaio-copertura-fotovoltaico.webp": "Steel roof structure prepared for photovoltaic panels — Salsomaggiore Terme (PR)",
